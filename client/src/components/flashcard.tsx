      ...
      <div className={`flashcard-inner ${isFlipped ? 'flipped' : ''}`}>
        ...
        <div className="flashcard-face flashcard-back">
          <div className="bg-white rounded-2xl shadow-lg p-6 cursor-pointer">
            ...
            {/* Furigana Reading */}
            <div className="text-center mb-4">
              <p className="text-lg text-gray-600 mb-2">Reading:</p>
            ...
            <div className="text-center mb-6">
              <p className="text-lg text-gray-600 mb-2">Korean:</p>
            ...
            <div className="text-center">
              <p className="text-lg text-gray-600 mb-2">Sentence:</p>
