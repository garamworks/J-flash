        ...
        <div className={`flashcard-inner ${isFlipped ? 'flipped' : ''} ${isTransitioning ? 'transitioning' : ''}`}>
          ...
          <div className="flashcard-face flashcard-back">
            <div className="bg-white rounded-2xl shadow-lg p-6 cursor-pointer h-full flex flex-col justify-center relative">
              {level === "Hiragana/Katakana" ? (
                // Hiragana/Katakana back layout
                <>
                  {/* Speaker Button */}
                  <button
                    className="speaker-btn absolute bottom-6 right-6 bg-blue-500 hover:bg-blue-600 rounded-full shadow-md flex items-center justify-center"
                    onClick={handleWordAudioClick}
                    title="단어 발음"
                    style={{ touchAction: 'manipulation' }}
                  >
                  ...
                  {/* Character Audio Button - Left Bottom */}
                  <button
                    className="speaker-btn absolute bottom-6 left-6 bg-red-500 hover:bg-red-600 rounded-full shadow-md flex items-center justify-center"
                    onClick={handleCharacterAudioClick}
                    title="문자 발음"
                    style={{ touchAction: 'manipulation' }}
                  >
                ...
                <>
                  ...
                  <div className="text-center" style={{ marginBottom: '3.0rem' }}>
                    <p className="font-semibold text-gray-900" style={{ fontSize: '1.3125rem', lineHeight: '1.2' }}>
                      {flashcard.korean}
                    </p>
                  </div>
